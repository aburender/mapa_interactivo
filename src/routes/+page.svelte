<script lang="ts">
    ...
    function onclick(event: Event) {
        const targetSelector = (event.target as HTMLElement).dataset.target;
        if (targetSelector) {
            const target = document.querySelector(targetSelector) as HTMLElement;
            target.classList.toggle("ocultar");
        }
    }
